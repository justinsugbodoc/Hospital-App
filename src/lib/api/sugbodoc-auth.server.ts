...
export async function loginUser(identifier: string, password: string) {
  ...
  const usernameMap: Record<string, string> = {
    ...
    "carlo.mendoza": "carlo.mendoza@sugbodoc.test",
    "carlo.mendoza@sugbodoc.test": "carlo.mendoza@sugbodoc.test",
    "lea.fernandez": "lea.fernandez@sugbodoc.test",
    "lea.fernandez@sugbodoc.test": "lea.fernandez@sugbodoc.test",
...
export const MOCK_DOCTORS = [
  ...
  },
  {
    ...
    email: "carlo.mendoza@sugbodoc.test",
    specialty: "Dermatology",
    clinic: "Vicente Sotto Memorial Medical Center",
    phone: "+63 917 000 0004",
    birthday: "1984-11-05",
    gender: "Male",
    role: "Doctor",
    password: "doctor123",
    aliases: ["carlo.mendoza", "carlo.mendoza@sugbodoc.test"],
  },
  {
    id: "doctor_dr_5",
    providerId: "dr_5",
    name: "Dr. Lea Fernandez",
    initials: "LF",
    username: "lea.fernandez",
    email: "lea.fernandez@sugbodoc.test",
    ...
    role: "Doctor",
    password: "doctor123",
    aliases: ["lea.fernandez", "lea.fernandez@sugbodoc.test"],
  },
] as const;
